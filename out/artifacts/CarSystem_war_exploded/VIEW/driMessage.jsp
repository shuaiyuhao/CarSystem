...
<div class="container">
    ...
    <div class="gallery" style="opacity: 0.9; filter:Alpha(Opacity=50, Style=0)">
        <form action="/driTravel" method="post">
        <section class="jq22-content bgcolor-1" style="opacity: 0.7; filter:Alpha(Opacity=50, Style=0)">
            ...
            <span class="input input--nao">
					<input class="input__field input__field--nao" type="text" id="input-4" name="sitNum"/>
					<label class="input__label input__label--nao" for="input-3">
						<span class="input__label-content input__label-content--nao">可乘人数</span>
					</label>
					<svg class="graphic graphic--nao" width="300%" height="100%" viewBox="0 0 1200 60" preserveAspectRatio="none">
						<path d="M0,56.5c0,0,298.666,0,399.333,0C448.336,56.5,513.994,46,597,46c77.327,0,135,10.5,200.999,10.5c95.996,0,402.001,0,402.001,0"/>
					</svg>
